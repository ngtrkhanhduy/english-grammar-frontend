...
const CompoundSentenceLesson = () => {
    ...
    const exercises = {
        'Cấu trúc': [
            {
                rule: 'Câu ghép (Compound Sentence) là câu bao gồm hai hoặc nhiều mệnh đề độc lập được nối với nhau bằng liên từ kết hợp (for, and, nor, but, or, yet, so) hoặc dấu chấm phẩy.',
                examples: [
    ...
    const questions = [
        {
            ...
            options: ['She runs every morning.', 'She runs every morning, and she listens to music.'],
            correctAnswer: 'She runs every morning, and she listens to music.',
        },
        {
            id: 2,
            type: 'single',
            question: 'Which of the following is a compound sentence?',
            options: ['He plays soccer.', 'He plays soccer, but his brother prefers basketball.'],
            correctAnswer: 'He plays soccer, but his brother prefers basketball.',
        },
    ];
        ...
        <div>
            ...
            <div className={cx('exercise-container')}>
                ...
                <div className={cx('content')}>
                    {tabIndex === 0 ? (
                        <div>
                            <h3>Tổng quan về Câu ghép</h3>
                            <p>
                                Câu ghép (Compound Sentence) là câu chứa hai hoặc nhiều mệnh đề độc lập được nối với
                                nhau bằng liên từ kết hợp hoặc dấu chấm phẩy.
                            </p>
                        </div>
...
export default CompoundSentenceLesson;
