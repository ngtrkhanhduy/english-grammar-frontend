...
const ChoiceQuestionLesson = () => {
    ...
    const exercises = {
        'Cấu trúc': [
            {
                rule: 'Câu hỏi lựa chọn (Choice Question) là dạng câu hỏi yêu cầu người trả lời chọn giữa hai hoặc nhiều lựa chọn.',
                examples: ['Do you prefer coffee or tea?', 'Would you like pizza or pasta?'],
            },
        ],
    };
    ...
    const questions = [
        {
            id: 1,
            type: 'single',
            question: 'Which sentence is a choice question?',
            options: ['Do you like apples?', 'Do you prefer apples or oranges?'],
            correctAnswer: 'Do you prefer apples or oranges?',
        },
        {
            id: 2,
            type: 'single',
            question: 'Which of the following is a choice question?',
            options: ['What is your favorite color?', 'Would you like coffee or tea?'],
            correctAnswer: 'Would you like coffee or tea?',
        },
    ];
    ...
    return (
        <div>
            <h1>Bài học về Câu hỏi lựa chọn</h1>
            <div className={cx('exercise-container')}>
                ...
                <div className={cx('content')}>
                    {tabIndex === 0 ? (
                        <div>
                            <h3>Tổng quan về Câu hỏi lựa chọn</h3>
                            <p>
                                Câu hỏi lựa chọn (Choice Question) yêu cầu người trả lời chọn giữa hai hoặc nhiều tùy
                                chọn.
                            </p>
                        </div>
...
export default ChoiceQuestionLesson;
