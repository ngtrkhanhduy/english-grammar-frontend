...
const TagQuestionLesson = () => {
    ...
    const exercises = {
        'Cấu trúc': [
            {
                rule: 'Câu hỏi đuôi (Tag Question) là dạng câu hỏi ngắn được thêm vào cuối câu trần thuật để xác nhận hoặc hỏi ý kiến.',
                examples: ['You are a student, aren’t you?', 'She can swim, can’t she?'],
            },
        ],
    };
    ...
    const questions = [
        {
            id: 1,
            type: 'single',
            question: 'Which sentence contains a tag question?',
            options: ['You like pizza.', 'You like pizza, don’t you?'],
            correctAnswer: 'You like pizza, don’t you?',
        },
        {
            id: 2,
            type: 'single',
            question: 'What is the correct tag question for: "She is a teacher, ___?"',
        ...
        <div>
            ...
            <div className={cx('exercise-container')}>
                ...
                <div className={cx('content')}>
                    {tabIndex === 0 ? (
                        <div>
                            <h3>Tổng quan về Câu hỏi đuôi</h3>
                            <p>
                                Câu hỏi đuôi (Tag Question) là dạng câu hỏi được thêm vào cuối câu để xác nhận thông
                                tin.
                            </p>
                        </div>
...
export default TagQuestionLesson;
