...
const InterjectionLesson = () => {
    const [answers, setAnswers] = useState({});
    const [results, setResults] = useState(null);
    const [tabIndex, setTabIndex] = useState(0);
    const [showPopup, setShowPopup] = useState(false);

    const tabs = ['Tổng quan', 'Thán từ cảm thán', 'Thán từ giao tiếp', 'Bài tập'];
    ...
    const exercises = {
        'Thán từ cảm thán': [
            {
                rule: 'Thán từ cảm thán dùng để biểu đạt cảm xúc mạnh mẽ như vui mừng, ngạc nhiên, buồn bã.',
                examples: ['Wow!', 'Oh no!', 'Hurray!', 'Alas!'],
            },
        ],
        'Thán từ giao tiếp': [
            {
                rule: 'Thán từ giao tiếp được sử dụng trong hội thoại hàng ngày để gây chú ý hoặc thể hiện phản ứng.',
                examples: ['Hey!', 'Well...', 'Oh!', 'Ah!'],
            },
        ],
    };
    ...
    const questions = [
        {
            id: 1,
            type: 'single',
            question: 'Which is an interjection expressing excitement?',
            options: ['Wow!', 'And'],
            correctAnswer: 'Wow!',
        },
        {
            id: 2,
            type: 'single',
            question: 'Which is an interjection used in communication?',
            options: ['Oh!', 'Because'],
            correctAnswer: 'Oh!',
        },
    ];
        ...
        <div>
            ...
            <div className={cx('exercise-container')}>
                ...
                <div className={cx('content')}>
                    {tabIndex === 0 ? (
                        <div>
                            <h3>Tổng quan về Thán từ</h3>
                            <p>
                                Thán từ là từ hoặc cụm từ được sử dụng để biểu đạt cảm xúc hoặc gây sự chú ý trong hội
                                thoại.
                            </p>
                        </div>
                    ) : tabIndex < 3 ? (
...
export default InterjectionLesson;
