...
const CompoundComplexSentenceLesson = () => {
    ...
    const exercises = {
        'Cấu trúc': [
            {
                rule: 'Câu ghép - phức (Compound-Complex Sentence) là câu chứa ít nhất hai mệnh đề độc lập và ít nhất một mệnh đề phụ thuộc.',
                examples: [
                    'Although it was raining, we still went out, and we enjoyed the day.',
                    'She didn’t go to the party because she was sick, but she watched a movie instead.',
                ],
            },
        ],
    };
    ...
    const questions = [
        {
            ...
            options: ['She likes apples.', 'Although she likes apples, she prefers oranges, and she eats them often.'],
            correctAnswer: 'Although she likes apples, she prefers oranges, and she eats them often.',
        },
        {
            id: 2,
            type: 'single',
            question: 'Which of the following is a compound-complex sentence?',
            options: ['He left early.', 'Because he had an appointment, he left early, and he called his friend.'],
            correctAnswer: 'Because he had an appointment, he left early, and he called his friend.',
        },
    ];
    ...
    return (
        <div>
            <h1>Bài học về Câu ghép - phức</h1>
            <div className={cx('exercise-container')}>
                ...
                <div className={cx('content')}>
                    {tabIndex === 0 ? (
                        <div>
                            <h3>Tổng quan về Câu ghép - phức</h3>
                            <p>
                                Câu ghép - phức (Compound-Complex Sentence) là câu chứa ít nhất hai mệnh đề độc lập và
                                ít nhất một mệnh đề phụ thuộc.
                            </p>
                        </div>
...
export default CompoundComplexSentenceLesson;
