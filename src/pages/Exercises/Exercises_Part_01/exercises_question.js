export const questions_01_01 = [
    {
        ...
        options: [
            { label: 'A. fix', value: 'A' },
            { label: 'B. write', value: 'B' },
            { label: 'C. send', value: 'C' },
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. to employ', value: 'B' },
            { label: 'C. has been employed', value: 'C' },
            { label: 'D. employ', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            { label: 'A. experience', value: 'A' },
            { label: 'B. growth', value: 'B' },
            { label: 'C. formula', value: 'C' },
            { label: 'D. incentive', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. treat', value: 'B' },
            { label: 'C. treated', value: 'C' },
            { label: 'D. treating', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. relevantly', value: 'B' },
            { label: 'C. more relevantly', value: 'C' },
            { label: 'D. relevant', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            { label: 'A. yet', value: 'A' },
            { label: 'B. just', value: 'B' },
            { label: 'C. few', value: 'C' },
            { label: 'D. still', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. tiredly', value: 'B' },
            { label: 'C. openly', value: 'C' },
            { label: 'D. highly', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            { label: 'A. soon', value: 'A' },
            { label: 'B. very', value: 'B' },
            { label: 'C. that', value: 'C' },
            { label: 'D. still', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. necessarily', value: 'B' },
            { label: 'C. necessary', value: 'C' },
            { label: 'D. necessity', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. reliable', value: 'B' },
            { label: 'C. partial', value: 'C' },
            { label: 'D. extreme', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. strategically', value: 'B' },
            { label: 'C. strategies', value: 'C' },
            { label: 'D. strategic', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            { label: 'A. Then', value: 'A' },
            { label: 'B. So that', value: 'B' },
            { label: 'C. Before', value: 'C' },
            { label: 'D. Whereas', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. obstructed', value: 'B' },
            { label: 'C. obstruction', value: 'C' },
            { label: 'D. obstructing', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            { label: 'A. cooperative', value: 'A' },
            { label: 'B. visible', value: 'B' },
            { label: 'C. essential', value: 'C' },
            { label: 'D. alternative', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            { label: 'A. In addition to', value: 'A' },
            { label: 'B. The fact that', value: 'B' },
            { label: 'C. As long as', value: 'C' },
            { label: 'D. In keeping with', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. mechanic', value: 'B' },
            { label: 'C. mechanism', value: 'C' },
            { label: 'D. mechanical', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. agree', value: 'B' },
            { label: 'C. generate', value: 'C' },
            { label: 'D. perform', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            { label: 'A. himself', value: 'A' },
            { label: 'B. he', value: 'B' },
            { label: 'C. who', value: 'C' },
            { label: 'D. which', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. initially', value: 'B' },
            { label: 'C. periodically', value: 'C' },
            { label: 'D. physically', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. Even if', value: 'B' },
            { label: 'C. Whether', value: 'C' },
            { label: 'D. Given that', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. legalize', value: 'B' },
            { label: 'C. legally', value: 'C' },
            { label: 'D. legalizes', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. graduation', value: 'B' },
            { label: 'C. request', value: 'C' },
            { label: 'D. dispute', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            { label: 'A. accessorized', value: 'A' },
            { label: 'B. accessorize', value: 'B' },
            { label: 'C. accessorizes', value: 'C' },
            { label: 'D. accessories', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. importantly', value: 'B' },
            { label: 'C. importance', value: 'C' },
            { label: 'D. important', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            { label: 'A. After', value: 'A' },
            { label: 'B. Until', value: 'B' },
            { label: 'C. Below', value: 'C' },
            { label: 'D. Like', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. perspectives', value: 'B' },
            { label: 'C. installments', value: 'C' },
            { label: 'D. stages', value: 'D' },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'B. Whenever', value: 'B' },
            { label: 'C. Other', value: 'C' },
            { label: 'D. Fewer', value: 'D' },
        ],
        correct_answer: 'A', // Correct answer is 'A. Anyone'
    },
];
